...
\FEIauthor{Maroš Kocúr}
\FEItitle{Porovnanie spracovania 3D dát analytickým metódami a neurónovými sieťami}
\FEItitleEn{Comparison of 3D Data Processing by Analytical Methods and Neural Networks}
\FEIkeywords{RANSAC, PCL, neurónová sieť}
\FEIkeywordsEn{RANSAC, PCL, neural network}
\FEIregNr{FEI-xxxx-xxxx}
\FEIsupervisor{prof. Ing. Jarmila Pavlovičová, PhD.}
\FEIconsultant{Ing. Miroslav Kohút}
\FEIdate{15}{11}{2022} % Date of submission (Day, month, year)
