...
// "/home/laptop/school/BK/freenect2-test/outputs/vsetky_vrch1.pcd"
int
...
//     }
//   }
	pcl::io::loadPCDFile<pcl::PointXYZ> ("/home/laptop/school/BK/freenect2-test/outputs/sprej_vrch2.pcd", *cloud);
  ...
  pcl::SampleConsensusModelCylinder<pcl::PointXYZ>::Ptr
    model_c(new pcl::SampleConsensusModelCylinder<pcl::PointXYZ> (cloud));
