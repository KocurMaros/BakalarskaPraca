...
/// [registration]
      ...
      std::cout << hjk << " " << registered.height << " " << registered.width << std::endl;
      std::ofstream myfile;
      char file_name[15];
      sprintf(file_name, "points%d.pcd",hjk++);
      myfile.open (file_name);
      myfile << "VERSION 0.7" << std::endl << "FIELDS x y z rgb"<< std::endl << "SIZE 4 4 4 4"<< std::endl << "TYPE F F F U"<< std::endl << "COUNT 1 1 1 1"<< std::endl << "WIDTH 512"<< std::endl << "HEIGHT 424"<< std::endl << "VIEWPOINT 0 0 0 1 0 0 0"<< std::endl;
