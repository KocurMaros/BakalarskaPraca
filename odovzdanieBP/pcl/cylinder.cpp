...
main (int argc, char** argv)
{
  ...
  pass.setFilterLimits (0, 7); //filtrovanie dat od 1.5 metra dalej
  ...
  std::string out_plane = "export_diff_rad/planes/" + name + "_plane.pcd";
  ...
  seg.setMethodType (pcl::SAC_RANSAC);
  seg.setNormalDistanceWeight (0.4); //surface normals influence
  seg.setMaxIterations (10000);
  seg.setDistanceThreshold (0.3); //inlier
  seg.setRadiusLimits (0.001, 2);   //maximalny rozmer telesa
  ...
  else
  {
    ...
    std::string out_cylinder = "export_diff_rad/cylinders/" + name + "_cylinder.pcd";
